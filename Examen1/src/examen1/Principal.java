...
public class Principal extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jTextField3.setText("Ingrese su edad");

        jTextField4.setText("Ingrese su correo");

        jTextField5.setText("Ingrese su username");

        jTextField6.setText("Ingrese su supersecreta contrasena");
        ...
        jd_registrarLayout.setHorizontalGroup(
            ...
            .addGroup(jd_registrarLayout.createSequentialGroup()
                ...
                .addGroup(jd_registrarLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.CENTER)
        ...
        jLabel8.setText("Nombre_Completo");
    ...
    private void jButton1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jButton1MouseClicked
        ...
        if (users.size() == 0) {
            ...
            for (a = 0; a < users.size(); a++) {
                String con = users.get(a).getUser();
                String pass = users.get(a).getContrasena();
                String con2 = jTextField1.getText();
                String pass2 = jPasswordField1.getText();
                if (con.equals(con2) && pass.equals(pass2)) {
                    v = false;
                    break;
                } else {
                    v = true;
            ...
            if (v == false) {
                ...
                jTextField7.setText(users.get(a).getNombre_completo());
                jTextField9.setText(users.get(a).getCorreo());
                jTextField10.setText(users.get(a).getUser());
                jTextField11.setText(users.get(a).getContrasena());
                JOptionPane.showMessageDialog(this, "Si desea modificar haga el cambio deseado y luego presione modificar");
            ...
            if (v == true) {
                JOptionPane.showMessageDialog(this, "No existe ese usuario o su contrasena esta mala ");
            }
        }
    ...
    private void jButton4MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jButton4MouseClicked
        ...
        try {
            ...
            users.add(new Usuario(name, age, mail, username, contrasena));
            jTextField2.setText("");
            jTextField3.setText("");
            jTextField4.setText("");
            jTextField5.setText("");
    ...
    private void jButton5MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jButton5MouseClicked
        ...
        try {
            ...
            mail = jTextField9.getText();
            username = jTextField10.getText();
            contrasena = jTextField11.getText();
            users.get(a).setNombre_completo(name);
            users.get(a).setCorreo(mail);
            users.get(a).setUser(username);
            users.get(a).setContrasena(contrasena);
            System.out.println(users.get(a).getNombre_completo());
            jTextField7.setText(users.get(a).getNombre_completo());
            jTextField9.setText(users.get(a).getCorreo());
            jTextField10.setText(users.get(a).getUser());
            jTextField11.setText(users.get(a).getContrasena());
    ...
    private void jButton6MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jButton6MouseClicked
        ...
        if (command.contains("class")) {
            if (command.contains("create")) {
                ...
                clases k = new clases(d[2]);
                users.get(a).lista.add(k);
            }
            if (command.contains("modify")) {
                String d[] = command.split(" ");
                for (int b = 0; b < users.get(a).lista.size(); b++) {
                    if (users.get(a).lista.get(b).getClase_name().equals(d[2])) {
                        users.get(a).lista.get(b).setClase_name(d[4]);
                        break;
                    } else {
                        JOptionPane.showMessageDialog(this, "NO existe es clase");
                    }
                }
            }
        ...
        if (command.contains("atribute")) {
            if (command.contains("add")) {
                String d[] = command.split(" ");
                for (int b = 0; b < users.get(a).lista.size(); b++) {
                    if (users.get(a).lista.get(b).getClase_name().equals(d[3])) {
                        users.get(a).lista.get(b).atributos.add(d[4] + " " + d[5]);
                        break;
                    }
                }
            }
            if (command.contains("modify")) {
                ...
                for (int b = 0; b < users.get(a).lista.size(); b++) {
                    if (users.get(a).lista.get(b).getClase_name().equals(d[3])) {
                        for (int c = 0; c < users.get(a).lista.get(b).atributos.size(); c++) {
                            if (users.get(a).lista.get(b).atributos.get(c).equals(d[4] + " " + d[5])) {
                                users.get(a).lista.get(b).atributos.get(c).replaceAll(d[4] + " " + d[5], d[7] + " " + d[8]);
                                break;
                            }
                        }
                        break;
            ...
            if (command.contains("delete")) {
                ...
                for (int b = 0; b < users.get(a).lista.size(); b++) {
                    if (users.get(a).lista.get(b).getClase_name().equals(d[3])) {
                        for (int c = 0; c < users.get(a).lista.get(b).atributos.size(); c++) {
                            if (users.get(a).lista.get(b).atributos.get(c).equals(d[4] + " " + d[5])) {
                                users.get(a).lista.get(b).atributos.remove(c);
                                break;
                            }
                        }
                        break;
    ...
    private void jButton7MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jButton7MouseClicked
       jTextArea2.setText(users.get(a).lista.toString());
